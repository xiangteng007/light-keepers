...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Light Keepers 防災平台',
        short_name: 'LightKeepers',
        description: '台灣災難響應與緊急救援協調平台',
        theme_color: '#1a1a2e',
      ...
      devOptions: {
        enabled: false // Disable PWA in dev to prevent cache loops
      }
    })
  ],
  build: {
