...
export const NAV_GROUPS: NavGroupDef[] = [
    { id: 'emergency', label: '緊急快捷', icon: 'sos', order: 0, isPinned: true, isEmergency: true },
    { id: 'ops', label: '應變指揮', icon: 'command', order: 1 },
    { id: 'geo', label: '情資地圖', icon: 'map', order: 2 },
    { id: 'rescue', label: '救援行動', icon: 'triage', order: 3 },
    { id: 'logistics', label: '資源後勤', icon: 'inventory', order: 4 },
    { id: 'workforce', label: '人員動員', icon: 'teams', order: 5 },
    { id: 'insights', label: '分析知識', icon: 'analytics', order: 6 },
...
export const NAV_ITEMS: NavItemDef[] = [
    ...
    { id: 'incidents', icon: 'events', label: '事件列表', path: '/incidents', group: 'ops', order: 1, visible: true, emergencyCore: true, emergencyRank: 11 },
    { id: 'tasks', icon: 'tasks', label: '任務看板', path: '/tasks', group: 'ops', order: 2, visible: true, volunteerCore: true, emergencyCore: true, emergencyRank: 1 },
    { id: 'ics-dashboard', icon: 'location', label: 'ICS 派遣台', path: '/ics', group: 'ops', order: 3, visible: true, emergencyCore: true, emergencyRank: 12 },
    { id: 'ics-forms', icon: 'report', label: 'ICS 表單', path: '/ops/ics-forms', group: 'ops', order: 4, visible: false },
    { id: 'notifications', icon: 'notify', label: '通知中心', path: '/hub/notifications', group: 'ops', order: 5, visible: true, volunteerCore: true },
    { id: 'offline', icon: 'offline', label: '離線狀態', path: '/hub/offline', group: 'ops', order: 6, visible: false, emergencyCore: true, emergencyRank: 30 },
