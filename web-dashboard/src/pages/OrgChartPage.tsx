...
const initialData: OrgNode[] = [
    { id: 'root', name: '光守護者協會', type: 'organization', parentId: null, memberCount: 500 },
                ...
                >
                    ...
                    <div className="node-info">
                        ...
                        <div className="node-meta">
                            ...
                            <span className="node-count">{node.memberCount}人</span>
                        </div>
                    </div>
                </div>
                {children.length > 0 && (
        ...
        <div className="org-chart-page">
                        ...
                        <div className="list-view">
                            {nodes.map(node => (
                                ...
                                >
                                    ...
                                    <span className="item-count">{node.memberCount}人</span>
                                </div>
                            ))}
                        </div>
                    )}
                ...
                {selectedNode && (
                    <div className="detail-panel">
                        ...
                        <div className="detail-grid">
                            ...
                            <div className="detail-item">
                                <label>成員數</label>
                                <span>{selectedNode.memberCount}人</span>
                            </div>
                            <div className="detail-item">
                                <label>ID</label>
            ...
            <div className="org-stats">
                ...
                <div className="stat">
                    ...
                    <span className="stat-label">分會數</span>
                </div>
                <div className="stat">
                    <span className="stat-value">{nodes.filter(n => n.type === 'branch').length}</span>
                    <span className="stat-label">支部數</span>
                </div>
            </div>
        </div>
    );
