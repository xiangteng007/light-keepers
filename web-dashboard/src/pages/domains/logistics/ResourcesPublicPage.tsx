...
// API 基礎 URL - VITE_API_URL 不含 /api/v1，需要手動加�?
...
export default function ResourcesPublicPage() {
    ...
    const handleScan = () => {
        ...
        input.onchange = async (e) => {
            ...
            if (file) {
                // 這裡可以使用 jsQR 或其�?QR 解碼�?
                // 目前先顯示提�?
                alert('掃碼功能開發中，請使用搜尋功能查詢物�?);
            }
        };
        input.click();
    };
        ...
        <div className="page resources-public-page">
            ...
            <div className="page-header">
                <div className="page-header__left">
                    <h2>📦 物資查詢</h2>
                    <p className="page-subtitle">查看庫存與儲位資�?/p>
                </div>
                ...
                <>
                                    ...
                                    >
                                        <div className="resource-card__header">
                                            ...
                                            <div className="resource-card__badges">
                                                {isLow && <Badge variant="warning">⚠️ 低庫�?/Badge>}
                    ...
                    {(activeFilter === 'all' || activeFilter === 'equipment') && assets.length > 0 && (
                        <div className="assets-section">
                            <h3 className="section-title">🔧 器材狀�?/h3>
