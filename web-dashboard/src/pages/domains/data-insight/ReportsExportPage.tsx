        ...
        <div className="page reports-export-page">
            <div className="page-header">
                <div className="page-header__left">
                    <h2>📊 報表匯出</h2>
                    <p className="page-subtitle">下載統計報表與資料分�?/p>
                </div>
            </div>
            ...
            {volunteerReport && (
                <Card className="preview-card" padding="lg">
                    <h3>👥 志工時數報表預覽</h3>
                    <Badge>{volunteerReport.length} 筆資�?/Badge>
                    ...
                    {volunteerReport.length > 10 && (
                        <p className="preview-note">顯示�?10 筆，�?{volunteerReport.length} �?/p>
                    )}
                </Card>
            )}
