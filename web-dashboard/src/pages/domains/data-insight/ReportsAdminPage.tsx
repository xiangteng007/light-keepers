...
const STATUS_CONFIG: Record<string, { label: string; color: string }> = {
    pending: { label: '待審�?, color: '#FF9800' },
    confirmed: { label: '已確�?, color: '#4CAF50' },
    rejected: { label: '已駁�?, color: '#F44336' },
};

// 嚴重程度設定
const SEVERITY_CONFIG: Record<ReportSeverity, { label: string; color: string }> = {
    low: { label: '�?, color: '#4CAF50' },
    medium: { label: '�?, color: '#FF9800' },
    high: { label: '�?, color: '#F44336' },
    critical: { label: '緊�?, color: '#9C27B0' },
};
        ...
        <div className="page reports-admin-page">
            <div className="page-header">
                <div className="page-header__left">
                    <h2>📋 回報審核管理</h2>
                    <p className="page-subtitle">管理員審核回�?/p>
                </div>
            </div>
                    ...
                    <Card className="modal-content modal-content--lg" padding="lg" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="report-detail">
                            ...
                            <div className="report-detail__row">
                                ...
                                <span>{selectedReport.address || '未提�?}</span>
                            </div>
