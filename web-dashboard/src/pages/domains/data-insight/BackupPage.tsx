            ...
            <div className="backup-stats">
                ...
                <div className="stat-card">
                    ...
                    <div>
                        ...
                        <span className="stat-label">總使用空�?/span>
                    </div>
                </div>
                <div className="stat-card">
                    <Clock size={24} />
                    <div>
                        ...
                        <span className="stat-label">最近備�?/span>
                    </div>
                </div>
            </div>
            ...
            <div className="backup-list">
                ...
                {loading ? (
                    ...
                    <div className="empty">
                        <Database size={48} />
                        <p>尚無備份記錄</p>
                        <button onClick={() => setShowCreateModal(true)}>建立第一個備�?/button>
                    </div>
                ) : (
