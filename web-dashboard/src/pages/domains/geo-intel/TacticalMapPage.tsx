...
const MOCK_MARKERS: TacticalMarker[] = [
    ...
    { id: 't1', position: [120.295, 22.625], type: 'task', label: '任務: 物資配�? },
    { id: 'r1', position: [120.310, 22.620], type: 'resource', label: '物資�?A' },
    { id: 's1', position: [120.298, 22.632], type: 'sos', label: 'SOS 訊號' },
    { id: 'h1', position: [120.290, 22.628], type: 'hazard', label: '危險區�? 落石' },
    { id: 'rp1', position: [120.302, 22.635], type: 'rally', label: '集結�?Alpha' },
];
    ...
    return (
        <div className="tactical-map-page">
            ...
            <div className="legend">
                ...
                <div className="legend-item"><span className="dot rally"></span> 集結�?/div>
            </div>
        </div>
    );
};
