...
const AED_MIN_ZOOM = 17; // AED 最低顯示縮放等�?(�?50m 比例�?
const EVENT_ZOOM_LEVEL = 16;

// NCDR 核心示警類型定義（使用官�?AlertType ID�?
// 來源: https://alerts.ncdr.nat.gov.tw/RSS.aspx
const NCDR_CORE_TYPES = [
    { id: 6, name: '地震', icon: '🌍', color: '#5BA3C0' },       // 地震(中央氣象�?
    { id: 7, name: '海嘯', icon: '🌊', color: '#4DA6E8' },       // 海嘯(中央氣象�?
    { id: 5, name: '颱風', icon: '🌀', color: '#7B6FA6' },       // 颱風(中央氣象�?
    { id: 1051, name: '雷雨', icon: '⛈️', color: '#A67B5B' },    // 雷雨(中央氣象�?
    { id: 10, name: '降雨', icon: '🌧�?, color: '#6B8EC9' },      // 降雨(中央氣象�?
    { id: 9, name: '土石�?, icon: '⛰️', color: '#8B6B5A' },     // 土石�?農業�?
    { id: 1087, name: '火災', icon: '🔥', color: '#E85A5A' },    // 火災(內政部消防署)
];

// NCDR 擴展示警類型
const NCDR_EXTENDED_TYPES = [
    { id: 1060, name: '低溫', icon: '❄️', color: '#88CCEE' },    // 低溫(中央氣象�?
    { id: 1062, name: '濃霧', icon: '🌫�?, color: '#9AA5B1' },    // 濃霧(中央氣象�?
    { id: 1061, name: '強風', icon: '💨', color: '#7EC8E3' },    // 強風(中央氣象�?
    { id: 2107, name: '高溫', icon: '🌡�?, color: '#E8A65A' },    // 高溫(中央氣象�?
    { id: 8, name: '淹水', icon: '🌊', color: '#5AB3E8' },       // 淹水(水利�?
    { id: 12, name: '水庫放流', icon: '💧', color: '#5AAAE8' },  // 水庫放流(水利�?
    { id: 11, name: '河川高水�?, icon: '🏞�?, color: '#6BB3C9' }, // 河川高水�?水利�?
    ...
    { id: 1053, name: '傳染�?, icon: '🦠', color: '#8BC34A' },  // 傳染�?疾病管制�?
    { id: 1078, name: '空氣品質', icon: '😷', color: '#9E9E9E' }, // 空氣品質(環境�?
    { id: 1093, name: '林火', icon: '🌲', color: '#4CAF50' },    // 林火危險度預�?農業�?
    { id: 1080, name: '電力', icon: '�?, color: '#FFC107' },    // 電力中斷(台灣電力公司)
    { id: 1089, name: '停水', icon: '🚰', color: '#2196F3' },    // 停水(台灣自來水公�?
...
const getSeverityColor = (severity: number) => {
    ...
    if (severity >= 4) return '#C9A256'; // 緊�?- 橙色
...
const mapOptions: google.maps.MapOptions = {
    ...
    keyboardShortcuts: false, // 關閉鍵盤快捷鍵控制介�?
    tilt: 0, // 禁用傾斜
    heading: 0, // 固定朝向北方
    styles: [
        // 可選：自訂地圖樣�?
            ...
            <div className="page-header">
                <div className="page-header__left">
                    ...
                    <div className="header-layer-toggles">
                        ...
                        <label className="header-layer-toggle" title="需放大�?50m 比例尺才會顯�?>
                            <input
                                type="checkbox"
                                checked={showAed}
                                onChange={(e) => setShowAed(e.target.checked)}
                            />
                            <span>❤️ AED {showAed && currentZoom < AED_MIN_ZOOM && '(請放�?'}</span>
                        </label>
                        <label className="header-layer-toggle">
                            <input
                                type="checkbox"
                                ...
                                >
                                    <div className="gmap-infowindow">
                                        ...
                                        <p className="gmap-infowindow__desc">
                                            {infoWindowEvent.description || '無描�?}
                                        </p>
                            ...
                            {selectedNcdrAlert && selectedNcdrAlert.latitude && selectedNcdrAlert.longitude && (
                                ...
                                >
                                    <div className="gmap-infowindow">
                                        ...
                                        <p className="gmap-infowindow__desc">
                                            {selectedNcdrAlert.description || '無描�?}
                                        </p>
                                        <div className="gmap-infowindow__actions">
                        ...
                        <Card title="事件詳情" padding="md" className="map-event-detail">
                            <div className="map-event-detail__content">
                                ...
                                <div className="map-event-detail__info">
                                    ...
                                    <div>
                                        <strong>狀�?</strong> {selectedEvent.status === 'active' ? '進行�? : '已解�?}
                                    </div>
                                    <div>
                                        <strong>嚴重程度:</strong>
