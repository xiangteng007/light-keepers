...
const getWeatherIcon = (description: string): string => {
    ...
    if (description.includes('�?)) return '⛈️';
    if (description.includes('�?)) return '☁️';
    if (description.includes('�?)) return '☀�?;
...
export default function ForecastPage() {
    const [selectedCounty, setSelectedCounty] = useState('臺北�?);
    ...
    return (
        <div className="forecast-page">
            ...
            <div className="forecast-header">
                <h1>🌤�?氣象預報總覽</h1>
                <p className="forecast-subtitle">整合中央氣象署公開資�?/p>
            </div>
            ...
            {/* 載入�?*/}
            {loading && <div className="forecast-loading">載入�?..</div>}
