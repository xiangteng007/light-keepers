...
const CATEGORY_OPTIONS: { value: ActivityCategory; label: string; emoji: string }[] = [
    ...
    { value: 'community', label: '社區', emoji: '🏘�? },
...
const STATUS_MAP: Record<ActivityStatus, { label: string; color: string }> = {
    ...
    open: { label: '報名�?, color: '#22c55e' },
    closed: { label: '已截�?, color: '#f59e0b' },
    cancelled: { label: '已取�?, color: '#ef4444' },
    completed: { label: '已結�?, color: '#6b7280' },
};
                                ...
                                >
                                    ...
                                    <div className="activity-card__content">
                                        ...
                                        <div className="activity-card__info">
                                            ...
                                            <span><Users size={14} /> {activity.currentParticipants}/{activity.maxParticipants} �?/span>
                                        </div>

                                        {isRegistered(activity.id) && (
                                            <div className="activity-card__registered">
                                                <CheckCircle size={14} /> 已報�?
                                            </div>
                                        )}
                                    </div>
