...
const TYPE_CONFIG: Record<ReportType, { label: string; icon: string; color: string }> = {
    ...
    landslide: { label: '土石�?, icon: '⛰️', color: '#795548' },
    traffic: { label: '交通事�?, icon: '🚗', color: '#FF9800' },
    infrastructure: { label: '設施損壞', icon: '🏗�?, color: '#F44336' },
...
const SEVERITY_CONFIG: Record<ReportSeverity, { label: string; stars: number; color: string }> = {
    ...
    critical: { label: '緊�?, stars: 4, color: '#9C27B0' },
};
        ...
        <div className="page events-page">
            ...
            <div className="page-header">
                <div className="page-header__left">
                    <h2>🚨 災害回報</h2>
                    <span className="header-badge">{filteredReports.length} �?/span>
                </div>
            ...
            <div className="events-stats">
                <div className="stat-card stat-card--total">
                    ...
                    <div className="stat-card__content">
                        ...
                        <div className="stat-card__label">已確認回�?/div>
                    </div>
                </div>
                ...
                <div className="stat-card stat-card--pending">
                    ...
                    <div className="stat-card__content">
                        ...
                        <div className="stat-card__label">待審�?/div>
                    </div>
                </div>
            </div>
                        ...
                        return (
                            <Card key={report.id} className="event-card" padding="md">
                                ...
                                <div className="event-card__status">
                                    {!taskStatus ? (
                                        <span className="status status-pending">�?未派�?/span>
                                    ) : taskStatus.completed === taskStatus.pending + taskStatus.inProgress + taskStatus.completed ? (
                                        <span className="status status-completed">�?已完�?/span>
                                    ) : taskStatus.inProgress > 0 ? (
                                        <span className="status status-active">🟡 處理�?/span>
                                    ) : (
                                        <span className="status status-pending">🔵 已派�?/span>
                                    )}
                                </div>
                ...
                >
                    <div className="event-detail">
                        ...
                        <div className="event-detail__info">
                            ...
                            <div className="info-row">
                                <span className="info-label">👤 回報�?/span>
                                <span className="info-value">
                                    {selectedReport.reporterLineDisplayName || selectedReport.contactName || '(未提�?'}
                                </span>
                            </div>
                            ...
                            <div className="info-row">
                                <span className="info-label">�?審核�?/span>
                                <span className="info-value">{selectedReport.reviewedBy || '(未審�?'}</span>
                            </div>
                        </div>
                ...
                >
                    <div className="task-form">
                        ...
                        <div className="form-actions">
                            ...
                            >
                                {createTaskMutation.isPending ? '建立�?..' : '建立任務'}
                            </Button>
                        </div>
                    </div>
                </Modal>
