...
export default function TasksPage() {
    ...
    if (isLoading) {
        return <div className="page tasks-page"><div className="loading">載入�?..</div></div>;
    }
        ...
        <div className="page tasks-page">
            <div className="page-header">
                <div className="page-header__left">
                    <h2>任務管理</h2>
                    <Badge variant="default">�?{totalTasks} 個任�?/Badge>
                </div>
                ...
                <div className="modal-overlay" onClick={() => setShowAddModal(false)}>
                    <Card className="modal" padding="lg" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="form-group">
                            ...
                            >
                                <option value={5}>P5 - 緊�?/option>
                                <option value={4}>P4 - �?/option>
                                <option value={3}>P3 - �?/option>
                                <option value={2}>P2 - �?/option>
                                <option value={1}>P1 - 最�?/option>
                            </select>
                        </div>
    ...
    return (
        <div className="task-column">
            ...
            <div className="task-list">
                {tasks.length === 0 && (
                    <div className="empty-column">無任�?/div>
                )}
                {tasks.map((task) => {
