...
const MOCK_SERVICE_RECORDS: ServiceRecord[] = [
    ...
    { id: '3', taskTitle: '物資發放站志�?, date: '2024-02-28', hours: 6, status: 'completed', location: '台北市萬華區' },
...
const STATUS_CONFIG = {
    ...
    busy: { label: '執勤�?, color: '#f59e0b', bgColor: '#fef3c7' },
    ...
    useEffect(() => {
        const fetchVolunteer = async () => {
            ...
            try {
                ...
                setServiceRecords(MOCK_SERVICE_RECORDS); // 服務紀錄暫�?mock
            } catch (err) {
                    ...
                    <div className="info-tab">
                        <div className="info-section">
                            ...
                            <div className="info-grid">
                                ...
                                <div className="info-item">
                                    <label>LINE ID</label>
                                    <span>{volunteer.lineUserId || '未綁�?}</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="records-tab">
                        <div className="records-summary">
                            ...
                            <div className="summary-card">
                                ...
                                <span className="summary-label">總服務時�?/span>
                            </div>
                        </div>
                    ...
                    <div className="settings-tab">
                        <div className="settings-section">
                            ...
                            <div className="settings-actions">
                                <button className="btn btn-outline">📧 發送訊�?/button>
                        ...
                        <div className="settings-section danger-zone">
                            <h3>🚨 危險區�?/h3>
                            <p>以下操作不可逆，請謹慎操�?/p>
                            <button className="btn btn-danger">🗑�?永久刪除志工資料</button>
                        </div>
                    </div>
                )}
            </div>
