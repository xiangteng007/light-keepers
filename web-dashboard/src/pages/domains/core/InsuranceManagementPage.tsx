...
export default function InsuranceManagementPage() {
    ...
    const getInsuranceStatus = (insurance: VolunteerInsurance) => {
        ...
        if (now > validTo) return { status: 'expired', label: '已過�?, color: 'danger' };
        ...
        <div className="page insurance-management-page">
            <div className="page-header">
                <div className="header-left">
                    <h2>🛡�?我的保險</h2>
                    <p className="page-subtitle">管理您的志工保險紀�?/p>
                </div>
                ...
                <div className="summary-content">
                    ...
                    <div className="summary-text">
                        ...
                        {insurances.some(ins => getInsuranceStatus(ins).status === 'active') ? (
                            <Badge variant="success">有有效保�?/Badge>
                        ) : (
                            <Badge variant="warning">無有效保�?/Badge>
                        )}
                    </div>
                </div>
            </Card>
            ...
            {isLoading ? (
                ...
                <Card padding="lg" className="empty-state">
                    ...
                    <h3>尚無保險紀�?/h3>
                    <p>新增您的保險資料以確保任務出勤時有保�?/p>
                    <Button onClick={handleAdd}>新增第一筆保�?/Button>
                </Card>
            ) : (
            ...
            >
                <div className="insurance-form">
                    ...
                    <div className="form-section">
                        ...
                        <small className="form-hint">不選擇則表示涵蓋所有任務類�?/small>
                    </div>
