    ...
    return (
        <div className="container-fluid py-4">
            ...
            {loading ? (
                <div className="text-center py-5">
                    <div className="spinner-border text-primary" role="status">
                        <span className="visually-hidden">載入�?..</span>
                    </div>
                </div>
            ) : approvals.length === 0 ? (
                <Alert variant="info">
                        ...
                        <div key={approval.id} className="col-md-6 col-lg-4">
                            <Card className="shadow-sm h-100">
                                ...
                                <Card.Body>
                                    ...
                                    <div className="mb-2">
                                        <small className="text-muted">領用�?/small>
                                        <div>{approval.recipientName}</div>
                                    </div>
                                    <div className="mb-2">
                                        <small className="text-muted">用�?/small>
                                        <div className="text-truncate">{approval.purpose}</div>
                                    </div>
                                    <div className="mb-2">
                                        <small className="text-muted">申請�?/small>
            ...
            >
                ...
                <Modal.Body>
                    <Form.Group>
                        <Form.Label>拒絕原因（至�?5 個字�?/Form.Label>
                        <Form.Control
                            as="textarea"
                            rows={3}
                            value={rejectReason}
                            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setRejectReason(e.target.value)}
                            placeholder="請詳細說明拒絕原因，例如：庫存不足、用途不明確、領用人資訊有誤�?
                        />
                        <Form.Text className="text-muted">
                            已輸�?{rejectReason.length} 個字
                        </Form.Text>
                    </Form.Group>
                </Modal.Body>
                <Modal.Footer>
