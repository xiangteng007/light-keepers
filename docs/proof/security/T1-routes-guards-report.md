...
> **Generated**: 2026-01-13T02:08:26.330Z  
...
|--------|------:|
| Total Routes | 1108 |
| Protected Routes | 616 |
| Unprotected Routes | 492 |
| Public Routes | 1 |
| **Coverage** | **55.6%** |
...
| POST | `/attendance/check-in/gps` | backend/src/modules/attendance/attendance.controller.ts | 10 |
| POST | `/attendance/check-in/qr` | backend/src/modules/attendance/attendance.controller.ts | 24 |
| PUT | `/attendance/check-out/:recordId` | backend/src/modules/attendance/attendance.controller.ts | 32 |
| GET | `/attendance/volunteer/:volunteerId` | backend/src/modules/attendance/attendance.controller.ts | 44 |
| GET | `/attendance/daily-summary` | backend/src/modules/attendance/attendance.controller.ts | 58 |
| GET | `/attendance/monthly-report/:volunteerId` | backend/src/modules/attendance/attendance.controller.ts | 66 |
| GET | `/attendance/generate-qr` | backend/src/modules/attendance/attendance.controller.ts | 78 |
...
| POST | `/community/posts` | backend/src/modules/disaster-community/disaster-community.controller.ts | 11 |
| GET | `/community/posts` | backend/src/modules/disaster-community/disaster-community.controller.ts | 17 |
| GET | `/community/posts/:id` | backend/src/modules/disaster-community/disaster-community.controller.ts | 23 |
| POST | `/community/posts/:id/like` | backend/src/modules/disaster-community/disaster-community.controller.ts | 29 |
| PUT | `/community/posts/:id/verify` | backend/src/modules/disaster-community/disaster-community.controller.ts | 35 |
| POST | `/community/posts/:postId/comments` | backend/src/modules/disaster-community/disaster-community.controller.ts | 41 |
| GET | `/community/posts/:postId/comments` | backend/src/modules/disaster-community/disaster-community.controller.ts | 47 |
| POST | `/community/articles` | backend/src/modules/disaster-community/disaster-community.controller.ts | 53 |
| GET | `/community/articles/search` | backend/src/modules/disaster-community/disaster-community.controller.ts | 59 |
| GET | `/community/articles/popular` | backend/src/modules/disaster-community/disaster-community.controller.ts | 65 |
| GET | `/community/articles/:id` | backend/src/modules/disaster-community/disaster-community.controller.ts | 71 |
| POST | `/community/organizations` | backend/src/modules/disaster-community/disaster-community.controller.ts | 77 |
| GET | `/community/organizations` | backend/src/modules/disaster-community/disaster-community.controller.ts | 83 |
| GET | `/community/organizations/:id` | backend/src/modules/disaster-community/disaster-community.controller.ts | 89 |
| PUT | `/community/organizations/:id/verify` | backend/src/modules/disaster-community/disaster-community.controller.ts | 95 |
| POST | `/community/collaborations` | backend/src/modules/disaster-community/disaster-community.controller.ts | 101 |
| GET | `/community/collaborations/:id` | backend/src/modules/disaster-community/disaster-community.controller.ts | 107 |
| GET | `/community/organizations/:orgId/collaborations` | backend/src/modules/disaster-community/disaster-community.controller.ts | 113 |
| POST | `/community/collaborations/:id/accept` | backend/src/modules/disaster-community/disaster-community.controller.ts | 119 |
| POST | `/community/collaborations/:id/complete` | backend/src/modules/disaster-community/disaster-community.controller.ts | 125 |
| GET | `/community/stats` | backend/src/modules/disaster-community/disaster-community.controller.ts | 131 |
| POST | `/api/donations` | backend/src/modules/donation-tracking/donation-tracking.controller.ts | 11 |
| POST | `/api/donations/:id/allocate` | backend/src/modules/donation-tracking/donation-tracking.controller.ts | 17 |
| GET | `/api/donations/:id/trail` | backend/src/modules/donation-tracking/donation-tracking.controller.ts | 23 |
| GET | `/api/donations/donor/:id` | backend/src/modules/donation-tracking/donation-tracking.controller.ts | 29 |
| GET | `/api/donations/public/stats` | backend/src/modules/donation-tracking/donation-tracking.controller.ts | 35 |
...
| POST | `/events` | backend/src/modules/events/events.controller.ts | 9 |
| GET | `/events` | backend/src/modules/events/events.controller.ts | 14 |
| GET | `/events/stats` | backend/src/modules/events/events.controller.ts | 19 |
| GET | `/events/:id` | backend/src/modules/events/events.controller.ts | 24 |
| PUT | `/events/:id` | backend/src/modules/events/events.controller.ts | 29 |
| DELETE | `/events/:id` | backend/src/modules/events/events.controller.ts | 34 |
...
| POST | `/line-bot/webhook` | backend/src/modules/line-bot/line-bot.controller.ts | 27 |
| POST | `/line-bot/alert` | backend/src/modules/line-bot/line-bot.controller.ts | 271 |
| POST | `/line-bot/broadcast` | backend/src/modules/line-bot/line-bot.controller.ts | 296 |
| GET | `/line-bot/rich-menu-config` | backend/src/modules/line-bot/line-bot.controller.ts | 307 |
| POST | `/line-bot/bind` | backend/src/modules/line-bot/line-bot.controller.ts | 325 |
| POST | `/line-bot/unbind` | backend/src/modules/line-bot/line-bot.controller.ts | 332 |
| GET | `/line-bot/binding-status/:lineUserId` | backend/src/modules/line-bot/line-bot.controller.ts | 339 |
| GET | `/line-bot/stats` | backend/src/modules/line-bot/line-bot.controller.ts | 346 |
| POST | `/line-bot/ncdr-broadcast` | backend/src/modules/line-bot/line-bot.controller.ts | 359 |
| POST | `/line-bot/ncdr-broadcast/region` | backend/src/modules/line-bot/line-bot.controller.ts | 379 |
...
| POST | `/payroll/calculate-shift` | backend/src/modules/payroll/payroll.controller.ts | 10 |
| POST | `/payroll/calculate-monthly/:volunteerId` | backend/src/modules/payroll/payroll.controller.ts | 24 |
| GET | `/payroll/records/:volunteerId` | backend/src/modules/payroll/payroll.controller.ts | 35 |
| PUT | `/payroll/status/:recordId` | backend/src/modules/payroll/payroll.controller.ts | 43 |
| GET | `/payroll/rates` | backend/src/modules/payroll/payroll.controller.ts | 54 |
| PUT | `/payroll/rates` | backend/src/modules/payroll/payroll.controller.ts | 61 |
| GET | `/payroll/report` | backend/src/modules/payroll/payroll.controller.ts | 70 |
